...
const authConfig = {
    "siteName": "Kerem Aydınlar Fen Lisesi Arşivi", // Website name
    ...
    "refresh_token": "1//09pOZAdoHEOl9CgYIARAAGAkSNgF-L9Irx1298dvYWPdEDL9mL2Woh-2QW8Qr-ggeo2qx16ks5347kU9X5xYc92pzaDAJa2FNTw", // Authorize token
    ...
    "roots": [
        {
            "id": "1lwgY8hoLYr0JZWvXJXnCL4an_eD17wgEUH_CgjUzzjX9xZaZfmLJavdsmFYyE5d6zPbF3Chy",
            "name": "projeler",
            "protect_file_link": false,
            // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
        },
        {
            "id": "1hl1gxHWSGClX0oqHpZW6e3yYGXkkQSZ5",
            "name": "öğretmen dosyaları",
            "protect_file_link": false,
            "auth": { "mhbd": "147258369.", "username1": "password1" } /* Remove double slash before "auth" to activate id password protection */
        },
    ]
};
...
const uiConfig = {
    ...
    "favicon": "https://pbs.twimg.com/profile_images/1218092862388297728/xdjjgzuS_400x400.jpg",
    // if logo is true then link otherwise just text for name
    "logo_link_name": "https://pbs.twimg.com/profile_images/1218092862388297728/xdjjgzuS_400x400.jpg",
    "fixed_header": true, // If you want the footer to be flexible or fixed.
    "header_padding": "150", // Value 80 for fixed header, Value 20 for flexible header. Required to be changed accordingly in some themes.
    "nav_link_1": "Ana sayfa", // change navigation link name
    "nav_link_3": "dosya konumu", // change navigation link name
    "nav_link_4": "Destek", // change navigation link name
    ...
    "contact_link": "mailto:muhammedbodruk2@gmail.com", // Link to Contact Button on Menu
    "copyright_year": "2023", // year of copyright, can be anything like 2015 - 2020 or just 2020
    "company_name": "Kerem Aydınlar Fen Lisesi", // Name next to copyright
    "company_link": "https://kaflarchive.com.tr/", // link of copyright name
                     ...
                     <a class="navbar-brand" href="/">${uiConfig.logo_image ? '<img border="0" alt="' + uiConfig.company_name + '" src="' + uiConfig.logo_link_name + '" height="' + uiConfig.height + '" width="' + uiConfig.logo_width + '">' : uiConfig.logo_link_name}</a>
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                         ...
                         <form class="d-flex" method="get" action="/0:search">
                            <input class="form-control me-2" name="q" type="search" placeholder="ara" aria-label="Search" value="" required="">
                            <button class="btn btn btn-danger" onclick="if($('#search_bar_form>input').val()) $('#search_bar_form').submit();" type="submit">ara</button>
                         </form>
                      </div>
                   </div>
                </nav>
          ...
          <div>
             <div id="content" style="padding-top: ${uiConfig.header_padding}px;">
                <div class="container">
                   ...
                   <div class="${uiConfig.file_count_alert_class} text-center" role="alert" id="count">toplam <span id="n_drives" class="number text-center"></span> drives</div>
                </div>
             </div>
             ...
             <br>
             <footer class="footer mt-auto py-3 text-muted ${uiConfig.footer_style_class}" style="${uiConfig.fixed_footer ? 'position: fixed; ' : ''}left: 0; bottom: 0; width: 100%; color: white; z-index: 9999;${uiConfig.hide_footer ? ' display:none;' : ' display:block;'}"> <div class="container" style="width: auto; padding: 0 10px;"> <p class="float-end"> <a href="#">geri dön</a> </p> ${uiConfig.credit ? '<p>Redesigned with <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" /> </svg> by <a href="https://www.npmjs.com/package/@googledrive/index" target="_blank">TheFirstSpeedster</a>, based on Open Source Softwares.</p>' : ''} <p>© ${uiConfig.copyright_year} - <a href=" ${uiConfig.company_link}" target="_blank"> ${uiConfig.company_name}</a></p> </div> </footer>
          </div>
       </body>
